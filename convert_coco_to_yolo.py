...
def convert_coco_to_yolo(coco_json_path, output_dir):
    ...
    print(f"  转换完成: {converted_count} 个文件, {error_count} 个错误")
    return converted_count


def main():
    # 配置路径
    base_dir = Path('/data1/undergraduate/ultralytics/ultralytics/dataset_coco')
